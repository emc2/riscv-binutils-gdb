...
#define MATCH_ENG_ACQ 0x707b
#define MASK_ENG_ACQ  0x200707f
#define MATCH_ENG_REL 0x200707b
#define MASK_ENG_REL  0xfff07fff
#define MATCH_ENG_TRANS 0x2200707b
#define MASK_ENG_TRANS  0xfe00707f
#define MATCH_ENG_REBIND 0x1200707b
#define MASK_ENG_REBIND  0xfe007fff
#define MATCH_ENG_EHSAVE 0xa00707b
#define MASK_ENG_EHSAVE  0xfff0707f
#define MATCH_ENG_SAVECNT 0x2a00707b
#define MASK_ENG_SAVECNT  0xfff0707f
#define MATCH_ENG_SAVE 0x1a00707b
#define MASK_ENG_SAVE  0xfe00707f
#define MATCH_ENG_RESTORE 0x3a00707b
#define MASK_ENG_RESTORE  0xfe00707f
#define MATCH_ENG_ICMD 0x7b
#define MASK_ENG_ICMD  0x707f
#define MATCH_ENG_S1CMD 0x107b
#define MASK_ENG_S1CMD  0x707f
#define MATCH_ENG_S2CMD 0x207b
#define MASK_ENG_S2CMD  0x707f
#define MATCH_ENG_S3CMD 0x307b
#define MASK_ENG_S3CMD  0x707f
#define MATCH_ENG_RCMD 0x407b
#define MASK_ENG_RCMD  0x707f
#define MATCH_ENG_RS1CMD 0x507b
#define MASK_ENG_RS1CMD  0x707f
#define MATCH_ENG_RS2CMD 0x607b
#define MASK_ENG_RS2CMD  0x707f
...
DECLARE_INSN(eng_acq, MATCH_ENG_ACQ, MASK_ENG_ACQ)
DECLARE_INSN(eng_rel, MATCH_ENG_REL, MASK_ENG_REL)
DECLARE_INSN(eng_trans, MATCH_ENG_TRANS, MASK_ENG_TRANS)
DECLARE_INSN(eng_rebind, MATCH_ENG_REBIND, MASK_ENG_REBIND)
DECLARE_INSN(eng_ehsave, MATCH_ENG_EHSAVE, MASK_ENG_EHSAVE)
DECLARE_INSN(eng_savecnt, MATCH_ENG_SAVECNT, MASK_ENG_SAVECNT)
DECLARE_INSN(eng_save, MATCH_ENG_SAVE, MASK_ENG_SAVE)
DECLARE_INSN(eng_restore, MATCH_ENG_RESTORE, MASK_ENG_RESTORE)
DECLARE_INSN(eng_icmd, MATCH_ENG_ICMD, MASK_ENG_ICMD)
DECLARE_INSN(eng_s1cmd, MATCH_ENG_S1CMD, MASK_ENG_S1CMD)
DECLARE_INSN(eng_s2cmd, MATCH_ENG_S2CMD, MASK_ENG_S2CMD)
DECLARE_INSN(eng_s3cmd, MATCH_ENG_S3CMD, MASK_ENG_S3CMD)
DECLARE_INSN(eng_rcmd, MATCH_ENG_RCMD, MASK_ENG_RCMD)
DECLARE_INSN(eng_rs1cmd, MATCH_ENG_RS1CMD, MASK_ENG_RS1CMD)
DECLARE_INSN(eng_rs2cmd, MATCH_ENG_RS2CMD, MASK_ENG_RS2CMD)
